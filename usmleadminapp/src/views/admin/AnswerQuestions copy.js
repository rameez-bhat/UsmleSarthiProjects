...
const AddFollowup = (followupno) => {
  setCommonUserQuestionData(prev => [
      ...prev,
      {
        ...
        Notes: '',
        CrossSell: '',
        NoteRegarding: NoteRegardingLast,
        ActionItem: 'For Both',
        AddedBy: {
  ...
  return (
    ...
    <div className="RotationAddedPayment " >
       	<div className="TitleDiv">
            <Typography  sx={{ flexGrow: 1, backgroundColor: '#b2ebf2', p: 1, borderRadius: 2 }}><b>Reply To User:</b>  </Typography>
        </div>
      ...
      : dayjs();
      NoteRegardingLast=NotesObject.NoteRegarding;
       		return (
