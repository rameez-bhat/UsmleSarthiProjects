...
const UserDetails = () => {
  ...
  dayjs().hour(23).minute(59).second(59)
  	...
  	const [startDateView, setStartDateView] = useState(dayjs(new Date(new Date().setMonth(new Date().getMonth() - 100))));
    	...
    	if(Cond==="NotesDate")
    	{
    		...
    		[
  				[
    				...
    				{ name:'NoteRegarding',condition:"==",value:"Research" },
    				{ name:'AddedBy.UserType',condition:"==",value:"Student" }
  				],
  			];
...
const hideLoader = () => {
  ...
  showMonthDropdown
      ...
      <div style={{
				...
				fontSize: '22px',
				fontWeight: 'bolder'
                }}>Recent Asked Question Of Research</div>
