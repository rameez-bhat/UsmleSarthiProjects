...
import { ResearchAvailabilityService } from "./services/researchavailability.service";
...
@Component({
  ...
  templateUrl: "./researchavailability.component.html",
  styleUrls: ["./researchavailability.component.scss"],
})

export class ResearchAvailabilityComponent implements OnInit {
  ...
  constructor(
    ...
    private dbService: ResearchAvailabilityService,
      ...
      if(typeof this.auth.userData=="undefined")
      {
        ...
        const response = await fetch('https://stripesession-5rztgyg64q-uc.a.run.app', {
          ...
          body: JSON.stringify({
            ...
            currency: 'usd',
            description: `USMLE Research Fee, Plan(${this.matchId}) Booking`,
